...
interface EstudiantesTableProps {
  ...
  onToggleColumn: (column: keyof EstudiantesTableProps['visibleColumns']) => void;
  onAddUser: () => void;
...
export default function EstudiantesTableSimple({ 
  usuarios,
  totalUsuarios,
  visibleColumns,
  showColumnSettings,
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 p-4 dark:border-white/[0.05]">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-500 dark:text-gray-400">Total Estudiantes:</span>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  checked={visibleColumns.codigoEstudiante}
                  onChange={() => onToggleColumn('codigoEstudiante')}
                  className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Código Estudiante</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
        ...
        <Table>
          <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              ...
              {visibleColumns.codigoEstudiante && (
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">
                  CÓDIGO
                </TableCell>
              )}
              ...
              return (
                <TableRow key={usuario.idUsuario}>
                  ...
                  {visibleColumns.codigoEstudiante && (
                    <TableCell className="px-5 py-4 text-start">
                      <span className="text-sm text-gray-600 dark:text-gray-400 break-words">
                        {usuario.Estudiante?.codigoEstudiante || '-'}
                      </span>
                    </TableCell>
                  )}
