...
interface AdministrativosTableProps {
  ...
  onToggleColumn: (column: keyof AdministrativosTableProps['visibleColumns']) => void;
  onAddUser: () => void;
...
export default function AdministrativosTableSimple({ 
  usuarios,
  totalUsuarios,
  visibleColumns,
  showColumnSettings,
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 p-4 dark:border-white/[0.05]">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-500 dark:text-gray-400">Total Administrativos:</span>
