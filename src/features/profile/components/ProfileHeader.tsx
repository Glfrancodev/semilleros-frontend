      ...
      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
          ...
          <UserAvatar
            ...
            iniciales={user?.iniciales || iniciales}
            nombre={fullName}
            size="xl"
          />
          ...
          <div className="order-3 xl:order-2 flex-1">
            ...
            {profile.bio && (
              <p className="mb-2 text-sm text-center text-gray-600 dark:text-gray-300 xl:text-left">
                {profile.bio}
              </p>
            )}
            ...
            {profile.Estudiante && (
              <div className="mt-2 text-center xl:text-left">
                <span className="text-xs text-gray-500 dark:text-gray-400">
                  Código: {profile.Estudiante.codigoEstudiante}
                </span>
              </div>
            )}
            {profile.Docente && (
              <div className="mt-2 text-center xl:text-left">
                <span className="text-xs text-gray-500 dark:text-gray-400">
                  Código Docente: {profile.Docente.codigoDocente}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="order-2 flex items-center gap-2 xl:order-3">
            ...
            >
              {profile.estaActivo ? "Activo" : "Inactivo"}
            </span>
            ...
            <div className="flex items-center gap-2 ml-2">
              ...
              {profile.github && (
                <a
                  ...
                  aria-label="GitHub"
                >
                  <svg className="fill-current" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
