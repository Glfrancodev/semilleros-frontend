import { RankingCategoriasFrecuentesData } from "../../../../types/reportes";

interface Props {
    data: RankingCategoriasFrecuentesData | null;
    loading: boolean;
    reporteGenerado: boolean;
    visibleColumns?: string[];
}

export default function RankingCategoriasFrecuentesTable({ data, loading, reporteGenerado, visibleColumns = [] }: Props) {
        ...
        return (
            <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8">
                ...
                <div className="text-center text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm mt-2">
                        No se encontraron categorías con proyectos
                    </p>
                </div>
            </div>
        );
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
                        ...
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">
                            {data.estadisticas.totalCategorias}
                        </p>
                    </div>
                    <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
                    ...
                    <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
                        <p className="text-sm text-gray-600 dark:text-gray-400">Categoría Dominante</p>
                        <p className="text-lg font-bold text-green-600 dark:text-green-400 truncate" title={data.estadisticas.categoriaDominante.nombre}>
                            {data.estadisticas.categoriaDominante.nombre}
                        </p>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            {data.estadisticas.categoriaDominante.porcentaje.toFixed(1)}%
                        </p>
                    </div>
                </div>
                        ...
                        <table className="w-full">
                            <thead className="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    {isColumnVisible("nombreCategoria") && (
                            ...
                            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                {data.ranking.map((item, index) => (
                                    <tr
                                        key={item.categoria.idCategoria}
